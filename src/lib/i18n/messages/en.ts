const en = {
  ...
  rejected_transaction_candidate: 'Rejected candidate',
  rejected_transaction_candidate_desc: 'RPC reported this hash as a rejected recent candidate; it is not present in the canonical block transaction list.',
